        ...
        <>
            ...
            <main className="min-h-screen pt-32 pb-20 bg-[#f4f6fb]">
                <div className="max-w-7xl mx-auto px-6 md:px-10">
                    ...
                    <button
                        onClick={() => router.back()}
                        className="mb-8 flex items-center gap-2 px-4 py-2 bg-white rounded-lg border border-gray-200 text-sm font-bold text-[#1e3a8a] shadow-sm hover:bg-gray-50 transition-all cursor-pointer"
                    >
                        ...
                        <div className="lg:col-span-7 flex flex-col gap-4 lg:sticky lg:top-32 self-start">
                            <div className="bg-white rounded-3xl overflow-hidden border border-gray-200 shadow-xl flex items-center justify-center relative aspect-square max-h-[calc(100vh-250px)]">
                                ...
                                <div className="absolute inset-x-4 top-1/2 -translate-y-1/2 flex justify-between pointer-events-none">
                                    <button className="w-10 h-10 rounded-full bg-white/80 shadow-md flex items-center justify-center pointer-events-auto opacity-50 cursor-pointer">
                        ...
                        <div className="lg:col-span-5">
                            <div className="bg-white rounded-3xl p-8 border border-gray-200 shadow-xl sticky top-32">
                                ...
                                <a
                                    ...
                                    className="w-full py-4 bg-[#22c55e] text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:brightness-110 active:scale-95 transition-all shadow-lg shadow-green-500/20 uppercase text-sm tracking-wide cursor-pointer"
                                >
